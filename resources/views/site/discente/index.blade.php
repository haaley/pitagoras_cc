...
@section('sub-header-title','Discente')
@section('breadcrumb-current', 'Discente')
                        ...
                        <div class="nicdark_section">
                            ...
                            <div class="nicdark_section ">
                                ...
                                <div class="nicdark_section nicdark_position_relative">
                                    ...
                                    <img alt="" class="nicdark_section" src="{{asset($discente->img)}}">
                                ...
                                <div class="nicdark_section nicdark_padding_20 nicdark_box_sizing_border_box">
                                    ...
                                    <h2><strong>{{ $discente->nome }}</strong></h2>
                                    <div class="nicdark_section nicdark_height_10"></div>
                                    <h6 class="nicdark_text_transform_uppercase nicdark_color_grey">Professor</h6>
                                    <div class="nicdark_section nicdark_height_20"></div>
                                    <p>{{ $discente->descricao }}</p>
                                    <div class="nicdark_section nicdark_height_20"></div>
                                    <a class="nicdark_display_inline_block nicdark_color_white nicdark_bg_blue nicdark_first_font nicdark_padding_8 nicdark_border_radius_3 nicdark_font_size_13" href="{{route('docente.single', ['slug' => $discente->url])}}">Ver Perfil</a>
