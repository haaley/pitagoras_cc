...
@section('background-subheader')
    <div class="nicdark_section nicdark_background_size_cover nicdark_background_position_center_bottom"
         style="background-image:url('{{$post->figure}}'); background-attachment: fixed;">
        @endsection
        @section('css')
                            ...
                            <div class="post-info-panel">
                                <p class="info">
                                    <label class="info-title">Direitos Autorais:</label><i
                                            ...
                                            href="https://creativecommons.org/licenses/by-nc-nd/3.0/deed.zh">Licença
                                        Creative Sharing 3.0</a>）
                                </p>
                                <p class="info">
                                    <label class="info-title">Data de
                                        criação:</label>{{ $post->created_at->format('Y.m.d') }}
                                </p>
                                @if(isset($post->published_at) && $post->published_at)
                                    <p class="info">
                                        <label class="info-title">Data de
                                            modificaçao:</label>{{ $post->published_at->format('Y.m.d') }}
                                    </p>
                                @else
                                    <p class="info">
                                        <label class="info-title">Data de
                                            modificaçao:</label>{{ $post->published_at}}
                                    </p>
                                @endif
                        ...
                        <div class="nicdark_section">
                            <div class="nicdark_width_60_percentage nicdark_padding_10  nicdark_box_sizing_border_box nicdark_float_left nicdark_position_relative">
                                <img alt=""
                                     ...
                                     width="15" src="http://localhost:8000/site/img/icons/icon-pen.svg">
                            ...
                            <tr class="nicdark_border_bottom_2_solid_grey">
                                <td class="nicdark_padding_10 ">
                                    <img alt="" class="nicdark_margin_right_5" width="10"
                                         src="http://localhost:8000/site/img/icons/icon-next-grey.svg">
