...
class MentionedInComment extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->subject('Um comentário menciona você')
            ->line($this->comment->username . 'Em' . $data['type'] . ':' . $data['title'] . ' Dos comentários que você mencionou você:')
            ->line($this->raw_content)
            ->action('Visualizar', $data['url']);
    }
