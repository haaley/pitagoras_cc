...
{
    use SoftDeletes, CommentHelper, ConfigureHelper, Metable;
    ...
    protected $fillable = ['title', 'description', 'slug', 'figure', 'category_id', 'user_id', 'content', 'published_at', 'status', 'html_content'];
