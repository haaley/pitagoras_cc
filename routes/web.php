...
// Sobre
Route::get('sobre', ['uses' => 'HomeController@sobre', 'as' => 'sobre']);

// Curso
Route::group(['prefix' => 'curso'], function () {
    Route::get('/all', ['uses' => 'HomeController@curso', 'as' => 'curso.index']);
    Route::get('/{slug}', ['uses' => 'HomeController@cursoSingle', 'as' => 'curso.single']);
});

// Pesquisa
Route::group(['prefix' => 'pesquisa'], function () {
    Route::get('/all', ['uses' => 'HomeController@research', 'as' => 'research.index']);
    Route::get('/{slug}', ['uses' => 'HomeController@researchSingle', 'as' => 'research.single']);
});

// Docente
Route::group(['prefix' => 'docente'], function () {
    Route::get('/all', ['uses' => 'HomeController@docente', 'as' => 'docente.index']);
    Route::get('/{slug}', ['uses' => 'HomeController@docenteSingle', 'as' => 'docente.single']);
});

// Discentes
Route::group(['prefix' => 'discente'], function () {
    Route::get('/all', ['uses' => 'HomeController@discente', 'as' => 'discente.index']);
    // Route::get('/{slug}', ['uses' => 'HomeController@discenteSingle', 'as' => 'discente.single']);
});

// Projetos
Route::get('/projetos', ['uses' => 'HomeController@projetos', 'as' => 'projetos']);
...
//Contact
Route::get('contato', ['uses' => 'HomeController@contato', 'as' => 'contato']);
